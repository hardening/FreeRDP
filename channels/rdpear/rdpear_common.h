...
FREERDP_LOCAL BOOL ndr_read_KERB_RPC_OCTET_STRING(NdrContext* context, wStream* s, void* hints,
                                                  KERB_RPC_OCTET_STRING* res);
...
FREERDP_LOCAL BOOL ndr_write_KERB_ASN1_DATA(NdrContext* context, wStream* s,
...
FREERDP_LOCAL BOOL ndr_write_RPC_UNICODE_STRING(NdrContext* context, wStream* s,
