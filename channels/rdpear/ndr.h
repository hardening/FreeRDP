...
#define NDR_PTR_NULL ((UINT32)0x0000)


typedef BOOL (*NDR_READER_FN)(NdrContext* context, wStream* s, const void *hints, void* target);
typedef BOOL (*NDR_WRITER_FN)(NdrContext* context, wStream* s, const void *hints, const void* obj);
typedef BOOL (*NDR_DESTROY_FN)(NdrContext* context, void* obj);
typedef BOOL (*NDR_DUMP_FN)(NdrContext* context, void* obj);
...
#define NDR_SIMPLE_TYPE_DECL(LOWER, UPPER) \
	...
	NdrMessageType ndr_##LOWER##_descr()
...
BOOL ndr_read_uconformant_varying_array(NdrContext* context, wStream* s, const NdrVaryingArrayHints *hints,
		NdrMessageType itemType, void* ptarget);
BOOL ndr_write_uconformant_varying_array(NdrContext* context, wStream* s, const NdrVaryingArrayHints *hints,
