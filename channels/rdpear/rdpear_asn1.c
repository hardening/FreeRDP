...
#include "rdpear_asn1.h"
#include <winpr/asn1.h>

wStream* rdpear_enc_Checksum(UINT32 cksumtype, SecPkgContext_Asn1Data* payload)
{
	/**
	 * Checksum        ::= SEQUENCE {
	 *   cksumtype       [0] Int32,
...
wStream* rdpear_enc_EncryptedData(UINT32 encType, SecPkgContext_Asn1Data* payload)
{
	/**
