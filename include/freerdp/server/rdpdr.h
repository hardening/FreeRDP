...
extern "C"
{
	...
	struct s_rdpdr_server_context
	{
		...
		WINPR_ATTR_NODISCARD psRdpdrSmartcardConnectA
		    SmartcardConnectA; /**< Send SCardConnectW to the client. */
		...
		WINPR_ATTR_NODISCARD psRdpdrSmartcardControl
		    SmartcardControl; /**< Send control to the client. */
		...
		psRdpdrOnSmartcardControlComplete
		    OnSmartcardControlComplete; /**< Completion callback for SmartcardControl. */
		...
		psRdpdrOnSmartcardGetAttribComplete
		    OnSmartcardGetAttribComplete; /**< Completion callback for SmartcardGetAttr */
	};
