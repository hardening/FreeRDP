...
extern "C"
{
	...
	FREERDP_API BOOL per_write_length(wStream* s, int length);
	...
	FREERDP_API BOOL per_write_padding(wStream* s, int length);
	...
	FREERDP_API BOOL per_write_object_identifier(wStream* s, BYTE oid[6]);
	...
	FREERDP_API BOOL per_write_octet_string(wStream* s, BYTE* oct_str, int length, int min);
	FREERDP_API BOOL per_read_numeric_string(wStream* s, int min);
	FREERDP_API BOOL per_write_numeric_string(wStream* s, BYTE* num_str, int length, int min);
