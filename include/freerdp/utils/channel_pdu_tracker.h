...
extern "C"
{
	 ...
	 * @param packet the returned packet, nullptr if some parts are missing
	 * @return if the operation was successful
	 * @since version 3.28.0
	 */
	WINPR_ATTR_NODISCARD
	FREERDP_API BOOL ChannelPduTracker_poll(ChannelPduTracker* tracker, wStream** packet);
